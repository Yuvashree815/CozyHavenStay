...
const SearchResultsPage = () => {
  ...
  const handleClearFilters = () => {
    setFilters({
      hasFreeWifi: false, hasDining: false, hasParking: false,
      hasSwimmingPool: false, hasFitnessCenter: false, hasRoomService: false,
    });
    setPageNumber(1);
  };
    ...
    <div>
      ...
      <div style={{
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <button
            ...
            style={{
              background: activeFilterCount > 0
                ? 'var(--primary)' : 'var(--surface-warm)',
              border: `1.5px solid ${activeFilterCount > 0
          ...
          {AMENITY_OPTIONS.filter(a => filters[a.key]).map(({ key, label }) => (
            <span
              key={key}
              ...
              style={{
                ...
                fontWeight: 600, padding: '0.25rem 0.6rem',
            ...
            {AMENITY_OPTIONS.map(({ key, label }) => (
              <div className="col-md-4 col-6 mb-2" key={key}>
                <label style={{
                  ...
                  border: `1.5px solid ${filters[key]
                    ? 'var(--primary)' : 'var(--border)'}`,
                  borderRadius: 'var(--radius-sm)',
