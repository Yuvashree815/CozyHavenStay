...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ['fullName', 'email', 'password',
      'confirmPassword', 'gender', 'phoneNumber', 'address'];
    const newErrors = {};
    const newTouched = {};
            ...
            <form onSubmit={handleSubmit} noValidate>
                  ...
                  {[
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: formData.role === value ? 'white' : 'var(--text-primary)',
                      }}
                    >
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" name="fullName"
                  ...
                  onBlur={handleBlur} placeholder="Your full name"
                ...
                {touched.fullName && !errors.fullName && (
                  <div style={{ color: '#2ecc71', fontSize: '0.8rem', marginTop: '0.25rem' }}>
                    ✓ Looks good
                  </div>
                )}
              </div>
              ...
              <div className="mb-3">
                ...
                <input type="password" className="form-control" name="password"
                  ...
                  onBlur={handleBlur} placeholder="Create a strong password"
                ...
                {formData.password && (
                  <div style={{
                    ...
                    {[
                      ...
                      { rule: /[a-z]/.test(formData.password), text: 'One lowercase letter' },
              ...
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <select className="form-select" name="gender"
                    ...
                    onBlur={handleBlur} style={inputStyle('gender')}>
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input type="text" className="form-control" name="phoneNumber"
                    ...
                    onBlur={handleBlur} placeholder="9876543210"
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" name="address"
                  ...
                  onBlur={handleBlur} placeholder="Your address"
