...
using CozyHavenStayV3.ReviewService.Repositories.Implementations;
...
namespace CozyHavenStayV3.ReviewService
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var bookingServiceBaseUrl = builder.Configuration["Services:BookingServiceBaseUrl"]!;
            builder.Services.AddHttpClient<IBookingServiceClient, BookingServiceClient>(client =>
            {
                client.BaseAddress = new Uri(bookingServiceBaseUrl);
            });
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "CozyHavenStayV3 - Review Service", Version = "v1" });
